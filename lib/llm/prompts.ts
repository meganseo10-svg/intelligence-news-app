...
요약 기준:
- 기사 본문의 핵심 사실을 3~4문장으로 정확히 압축. 숫자·고유명사·금액·날짜는 보존.
- 제목 재진술 금지. 본문에 실제로 있는 내용만.

관련도(relevance_score) 기준 (사용자 회사 관점):
- 0.8~1.0: 우리 회사/제품/경쟁사/타겟 고객과 직접 관련.
- 0.4~0.7: 우리 업계·시장 전반과 관련.
- 0.0~0.3: 우리 비즈니스와 거의 무관 (일반 사회·연예·스포츠 등).
- 무관한 기사는 낮은 점수를 정직하게 매길 것.

시사점 작성 기준 (반드시 우리 회사 입장에서, 구체적 액션):
- sales_opportunity: "무엇을, 누구에게, 어떻게" 활용할지 한 문장. 일반론("기회가 있다") 금지.
- target_customer: 반응할 구체적 고객 세그먼트.
- risk_signal: 위협·시장 변화 신호. 없으면 빈 문자열.`;
